 ...
 */
package com.zb.as3.common.fileformats.zip {
	
	import com.zb.as3.common.fileformats.zip.crypt.ICrypto;
	import com.zb.as3.common.fileformats.zip.crypt.ZipCrypto;
	...
	[Event(name="zipDataCompress", type="com.zb.as3.common.fileformats.zip.ZipEvent")]
	[Event(name="zipFileCreated", type="com.zb.as3.common.fileformats.zip.ZipEvent")]
	...
	*/
	public class ZipFileWriter extends EventDispatcher{
		...
		private static var log:ILogger = Log.getLogger("com.zb.as3.common.fileformats.zip.ZipFileReader");
