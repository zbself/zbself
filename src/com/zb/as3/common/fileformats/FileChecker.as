package com.zbself.as3.framework.common.fileformats
{
	import com.zbself.as3.framework.utils.core.AbstractUtil;
	...
	/**
	 *	通过ByteArray 头编码 判断文件格式<br>
	 * 	查找FORMAT_DATA.FORMAT_DATA 中的头编码对应 FORMAT_DATA.FORMAT_NAME 的文件格式
	 * @param bytes
	 * @return 返回文件类型（部分特殊编码对应多个文件格式，则返回格式组 | 未找到则返回null）
	 */
	static public function getFormatByByteArray(bytes:ByteArray):*
	{
