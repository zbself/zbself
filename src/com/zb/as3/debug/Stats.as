package com.zb.as3.debug
{
	 ...
	 * <listing>
	 * 		addChild( new Stats() );
	 * 		addChild( new Stats( { bg: 0xffffff , fps: 0xC0C0C0, ms: 0x505050, mem: 0x707070, memmax: 0xA0A0A0 } ));
	 * </listing>
	 */
	...
	{	
		 ...
		 */
		public function Stats( _theme : Object = null, $showBackground:Boolean=true, $showFooter:Boolean=false, $width:int=70, $height:int=100) : void
		{
			if (_theme)
			{
